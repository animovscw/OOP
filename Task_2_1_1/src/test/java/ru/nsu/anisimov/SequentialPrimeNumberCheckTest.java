...
class PrimeNumberCheckTest {
    ...
    void testNonPrimeSequential() {
        ...
        Assertions.assertTrue(PrimeNumberCheck.NonPrimeSequential(arr1));
        Assertions.assertTrue(PrimeNumberCheck.NonPrimeSequential(arr2));
        Assertions.assertTrue(PrimeNumberCheck.NonPrimeSequential(arr3));
    }
    ...
    void testPrimeSequential() {
        ...
        Assertions.assertFalse(PrimeNumberCheck.NonPrimeSequential(arr1));
        Assertions.assertFalse(PrimeNumberCheck.NonPrimeSequential(arr2));
    }
