...
class HeapsortTest {
    ...
    @Test
    void twelfthTest() {
        int[] test12Array = new int[] {810, 230, 1138, 489, 631, 184, 894, 532, 466, 93, 193, 1075, 1226, 28, 86, 192, 706, 1139, 1190, 517, 998, 328, 776, 819, 329, 175, 163, 63, 226, 870, 985, 656, 653, 967, 201, 848, 534, 245, 1032, 396, 783};
        Heapsort.heapsort(test12Array);
        assertArrayEquals(new int[] {28, 63, 86, 93, 163, 175, 184, 192, 193, 201, 226, 230, 245, 328, 329, 396, 466, 489, 517, 532, 534, 631, 653, 656, 706, 776, 783, 810, 819, 848, 870, 894, 967, 985, 998, 1032, 1075, 1138, 1139, 1190, 1226}, test12Array);
    }
}